                        ...
                        <div class="row">
                            <div class="wrap-division">
                                <div class="col-md-6 col-sm-6 animate-box">
                                    <div class="tour">
                                        <a href="#" class="tour-img" style="background-image: url(images/tour-mumbai.jpg);">
                                            <p class="price"><span>₹5000</span> <small>/ 3 Days</small></p>
                                        </a>
                                        <span class="desc">
                                        ...
                                        <h2><a href="#">Family Tour in Maharashtra</a></h2>
                                ...
                                <div class="col-md-6 col-sm-6 animate-box">
                                    <div class="tour">
                                        <a href="#" class="tour-img" style="background-image: url(images/tour-manali.jpg);">
                                            <p class="price"><span>₹3000</span> <small>/ 3 Days</small></p>
                                        </a>
                                        <span class="desc">
											<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span></p>
                                        <h2><a href="#">Family Tour in Himachal Pradesh</a></h2>
                                        <span class="city">Manali, Himachal Pradesh</span>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6 animate-box">
                                    <div class="tour">
                                        <a href="#" class="tour-img" style="background-image: url(images/tour-agra.jpg);">
                                            <p class="price"><span>₹3500</span> <small>/ 3 Days</small></p>
                                        </a>
                                        <span class="desc">
											<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span></p>
                                        <h2><a href="#">Family Tour in Uttar Pradesh</a></h2>
                                        <span class="city">Agra, Uttar Pradesh</span>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6 animate-box">
                                    <div class="tour">
                                        <a href="#" class="tour-img" style="background-image: url(images/tour-rajasthan.jpg);">
                                            <p class="price"><span>₹4500</span> <small>/ 3 Days</small></p>
                                        </a>
                                        <span class="desc">
											<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span></p>
                                        <h2><a href="#">Family Tour in Rajasthan</a></h2>
                                        <span class="city">Jaipur, Rajasthan</span>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6 animate-box">
                                    <div class="tour">
                                        <a href="#" class="tour-img" style="background-image: url(images/GOA.jpg);">
                                            <p class="price"><span>₹7500</span> <small>/ 3 Days</small></p>
                                        </a>
                                        <span class="desc">
											<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span></p>
                                        <h2><a href="#">Family Tour in Goa</a></h2>
                                ...
                                <div class="col-md-6 col-sm-6 animate-box">
                                    <div class="tour">
                                        <a href="#" class="tour-img" style="background-image: url(images/tour-amritsar.jpg);">
                                            <p class="price"><span>₹5500</span> <small>/ 3 Days</small></p>
                                        </a>
                                        <span class="desc">
											<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span></p>
                                        <h2><a href="#">Family Tour in Punjab</a></h2>
                                        <span class="city">Amritsar, Punjab</span>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6 animate-box">
                                    <div class="tour">
                                        <a href="#" class="tour-img" style="background-image: url(images/tour-hyd.jpg);">
                                            <p class="price"><span>₹4500</span> <small>/ 3 Days</small></p>
                                        </a>
                                        <span class="desc">
											<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span></p>
                                        <h2><a href="#">Family Tour in Telangana</a></h2>
                                        <span class="city">Hyderabad, Telangana</span>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6 animate-box">
                                    <div class="tour">
                                        <a href="#" class="tour-img" style="background-image: url(images/tour-ranthambore.jpg);">
                                            <p class="price"><span>₹5000</span> <small>/ 3 Days</small></p>
                                        </a>
                                        <span class="desc">
											<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span></p>
                                        <h2><a href="#">Family Tour in Ranthambore National Park</a></h2>
                            ...
                            <div class="side search-wrap animate-box">
                                ...
                                <form method="post" class="colorlib-form">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                        <input type="submit" name="submit" id="submit" value="Find Flights" class="btn btn-primary btn-block" onclick="bookflight()">
                                        </div>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <form method="post" class="colorlib-form-2">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                                <label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Manali</h4>
												</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                                <label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Kanyakumari</h4>
												</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                                <label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Andaman</h4>
												</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                                <label class="form-check-label" for="exampleCheck1">
													<h4 class="place">Coimbatore</h4>
												</label>
                                            </div>
                                        </form>
                                    </div>
            ...
            <div class="container">
                <div class="row row-pb-md">
                    ...
                    <div class="col-md-2 colorlib-widget" style="padding-left: 50px;">
                        ...
                        <p>
                            <ul class="colorlib-footer-links">
                                <li><a href="book.php">Flight</a></li>
                                <li><a href="hotels.php">Hotels</a></li>
                                <li><a href="book.php">Train</a></li>
                                <li><a href="book.php">Car Rent</a></li>
                    ...
                    <div class="col-md-2 colorlib-widget" style="padding-left: 80px;">
                        ...
                        <p>
                            <ul class="colorlib-footer-links">
                                <li><a href="hotel.php">Taj Resort</a></li>
                                <li><a href="tour.php">Palolem Beach</a></li>
                                <li><a href="tour.php">Manali </a></li>
                                <li><a href="tour.php">Ladakh</a></li>
                                <li><a href="tour.php">Amarnath</a></li>
                            </ul>
                        </p>
                    </div>
